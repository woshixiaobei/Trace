...
CGFloat const kRZPopupMenuCenterBtnCenterX = 188.0f;
CGFloat const kRZPopupMenuCenterBtnCenterY = 642.0f;
...
{
    if (!_centerBtn) {
        _centerBtn = [[RZPopupMenuItem alloc] initWithImage:[UIImage imageNamed:@"bg-addbutton"] highlightedImage:[UIImage imageNamed:@"bg-addbutton-highlighted"] contentImage:[UIImage imageNamed:@"icon-plus"] contentHighlightedImage:[UIImage imageNamed:@"icon-plus-highlighted"]];
